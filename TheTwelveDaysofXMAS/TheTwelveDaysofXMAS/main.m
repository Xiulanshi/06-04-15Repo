...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        NSString *day = @"day of Christmas";
        NSString *love = @"my true love sent to me";
        NSArray *poem = @[@"first", @"second", @"third", @"fourth", @"fifth"];
        NSArray *gifts = @[@"a Partridge in a Pear Tree", @"Two Turtle Doves", @"Three French Hens", ];
